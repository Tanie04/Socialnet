...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        $message = "<span style='color: #2ecc71;'>Create a new account successfully!</span>";
    } else {
...
<head>
    ...
    <style>
        /* Font và màu nền tím nhạt toàn trang */
        body { 
        ...
        .register-container { 
            ...
            width: 400px; 
            text-align: left; /* Để label căn trái cho giống ảnh Nhi gửi */
        }

        /* Đổi Admin Panel thành Sign up */
        h1 { 
            text-align: center; 
            color: #5B3765; 
            font-size: 2rem; 
        ...
        input { 
            ...
            border-radius: 10px; /* Bo tròn ô nhập */
            box-sizing: border-box; 
            outline: none;
        }

        /* Nút Add user đổi sang màu tím của Menubar */
        .add-btn { 
